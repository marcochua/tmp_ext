...
import com.tooltwist.bsg.clientnz.PropertyIdResponse;
...
public class PropertyIdListFromSuggestionXpc implements XpcMethod
{
	...
	private static IBsgManagerNZ bsgManager;
	...
	public static final String METHOD_NAME = "getPropertyIdListFromSuggestionNZ";
	//Attrinutes
	...
	public XData runMethod(XpcSecurity credentials, Element elem) throws DinaaException
	{
		...
		//set bsgManager
		bsgManager = BsgServiceFactoryNZ.getBsgManagerNZ(requestTime, partnerSid);
