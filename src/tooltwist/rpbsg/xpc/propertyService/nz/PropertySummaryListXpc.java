...
import com.tooltwist.bsg.clientnz.BsgPropertySummary;
...
import com.tooltwist.bsg.clientnz.PropertySearchPropertiesResult;
import com.tooltwist.bsg.clientnz.PropertySearchProperty;
...
public class PropertySummaryListXpc implements XpcMethod
{
	...
	public static final String METHOD_NAME = "getPropertySummaryListNZ";
	//Attrinutes
	...
	public XData runMethod(XpcSecurity credentials, Element elem) throws DinaaException
	{
		...
		IBsgManagerNZ bsgManager = BsgServiceFactoryNZ.getBsgManagerNZ(requestTime,token);
