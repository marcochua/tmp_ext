 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://rpdata.com/bsg/schemas", wsdlLocation = "http://rpp.rpdata.com/bsgNZ-2.0/ws/userService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://rpdata.com/bsg/schemas", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://rpp.rpdata.com/bsgNZ-2.0/ws/userService.wsdl");
    ...
    public UserService getUserServiceSoap11() {
        return super.getPort(new QName("http://rpdata.com/bsg/schemas", "UserServiceSoap11"), UserService.class);
    }
    ...
    public UserService getUserServiceSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://rpdata.com/bsg/schemas", "UserServiceSoap11"), UserService.class, features);
    }
